---
description: Agente de TDD atualizado que escreve testes antes da implementação seguindo o ciclo Red-Green-Refactor.
name: tdd-updated
tools: ['search', 'search/codebase', 'search/usages', 'execute/runTests', 'edit/editFiles']
handoffs:
